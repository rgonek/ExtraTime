...
```bash
# Default mode
dotnet test tests/ExtraTime.NewIntegrationTests/ExtraTime.NewIntegrationTests.csproj
```
...
```bash
# Windows (PowerShell)
$env:TEST_MODE='SqlServer'; dotnet test tests/ExtraTime.NewIntegrationTests/ExtraTime.NewIntegrationTests.csproj

# Bash
TEST_MODE=SqlServer dotnet test tests/ExtraTime.NewIntegrationTests/ExtraTime.NewIntegrationTests.csproj
```
