...
- [ ] Create `TeamXgSnapshot` entity + EF configuration
- [ ] Create `TeamInjurySnapshot` entity + EF configuration
- [ ] Add snapshot DbSets to `IApplicationDbContext` and `ApplicationDbContext`
...
- [ ] Add migration(s) for snapshot tables
